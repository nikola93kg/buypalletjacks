...
export const metadata: Metadata = buildMetadata({
  title: `Pallet Jacks for Sale Near Me – ${LOCATION_COUNT} Pickup Locations`,
  description: `Find pallet jacks for sale near me with ${LOCATION_COUNT} Buy Pallet Jacks pickup locations across the USA. Select your state to see local refurbished and used pallet jack availability.`,
  path: "/locations",
  keywords: [
