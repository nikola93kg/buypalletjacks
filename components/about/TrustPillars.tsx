...
const PILLARS: Pillar[] = [
  ...
  },
  {
    ...
    description:
      "Pick up the same day from one of 29 locations nationwide — including weekends. No freight delays, no surprise shipping costs.",
    accentBg: "#DCFCE7",
    accentColor: "#16A34A",
  },
  {
    ...
    description:
      "Live inventory across all 29 locations. What you see is what's physically on the floor — ready to go today.",
    accentBg: "#E0E7FF",
    accentColor: "#1E3A8A",
  },
];
