...
const REASONS: Reason[] = [
  ...
  },
  {
    ...
    desc: "New equipment can take weeks to arrive. Our inventory is on-hand at 29 locations across the USA. Call, confirm, and pick up the same day — weekends included.",
    theme: "orange",
    icon: Clock3,
  },
  {
...
const COMPARISON: ComparisonRow[] = [
  ...
  { feature: "Pickup options", us: "29 locations nationwide", them: "Dealer or freight only" },
];
