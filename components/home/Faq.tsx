...
export const HOME_FAQS = [
  ...
  },
  {
    ...
    a: "Most buyers can use one of our 29 pickup locations across 19 states. Call or text us with your city and we will point you to the nearest available pallet jack pickup option.",
  },
  {
